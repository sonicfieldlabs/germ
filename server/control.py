...
from server.schemas import ControlCVProfile, ControlEvent, ControlPort, ControlRoute, ControlSnapshot
from server.storage import StorageManager, utc_now_iso
...
def default_control_ports() -> list[ControlPort]:
    return [
        ...
        ControlPort(
            id="cosmoaudition:observation",
            label="Cosmoaudition observation",
            kind="control",
            direction="output",
            scope="network",
            min=0.0,
        ...
        ControlPort(
            id="cosmoaudition:event",
            label="Cosmoaudition event pulse",
            kind="event",
            direction="output",
            scope="network",
            unit="trigger",
            metadata={"implementation": "explicit_observation_projection"},
        ),
        ControlPort(
            id="cosmoaudition:metadata",
            label="Cosmoaudition observation metadata",
            kind="metadata",
            direction="output",
            scope="metadata",
